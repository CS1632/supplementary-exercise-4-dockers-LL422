...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    assertEquals(vars.get("attribute").toString(), "https://cs1632.appspot.com/reset");
  }
  @Test
  ...
  public void tEST3CATALOG() {
    ...
    js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
    {
      WebElement element = driver.findElement(By.cssSelector("body > div > main > div.jumbotron > ol > li:nth-child(3) > img"));
  ...
  public void tEST5RENTACAT() {
    ...
    {
      List<WebElement> elements = driver.findElements(By.cssSelector("body > div > main > div.jumbotron > div:nth-child(3) > div:nth-child(3) > button"));
      assert(elements.size() > 0);
    }
    {
      List<WebElement> elements = driver.findElements(By.cssSelector("body > div > main > div.jumbotron > div:nth-child(4) > div:nth-child(3) > button"));
      assert(elements.size() > 0);
    }
  }
  @Test
  ...
  public void tEST7RETURN() {
    ...
    assertThat(driver.findElement(By.cssSelector("#listing > ul > li:nth-child(1)")).getText(), is("ID 1. Jennyanydots"));
    assertThat(driver.findElement(By.cssSelector("#listing > ul > li:nth-child(2)")).getText(), is("ID 2. Old Deuteronomy"));
    assertThat(driver.findElement(By.cssSelector("#listing > ul > li:nth-child(3)")).getText(), is("ID 3. Mistoffelees"));
    assertThat(driver.findElement(By.cssSelector("#returnResult")).getText(), is("Success!"));
  }
  @Test
  ...
  public void dEFECT3FUNFEED() {
    ...
    driver.findElement(By.cssSelector(".btn")).click();
    assertThat(driver.findElement(By.cssSelector("#feedResult")).getText(), is("Cat fight!"));
  }
}
